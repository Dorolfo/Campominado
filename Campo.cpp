/*
ALUNO:
Rdolfo Constancio de Almeida Lage 2016017890
*/
...
Tabuleiro :: Tabuleiro(int lin, int col, int bomba) //CONSTRUTOR
{
    ...
    for(int i=0; i<lin; i++) Matriz[i] = new Campo[col];   // CRIA A MATRIZ DE PONTEIROS
...
{
    ALLEGRO_BITMAP *vazio = al_load_bitmap("Aberto.jpg");
